...
export const monsters = {
    ...
    normal: {
        ...
        goblin: { name: "Cave Goblin", hp: 50, attack: 10, hitChance: 0.30, goldDrop: [10, 20] }
    },
    // Tier for Elite Battles
    elite: {
        stoneGolem: { name: "Stone Golem", hp: 150, attack: 10, hitChance: 0.40, goldDrop: [40, 60] },
        arcaneSprite: { name: "Arcane Sprite", hp: 100, attack: 20, hitChance: 0.40, goldDrop: [50, 75] }
    },

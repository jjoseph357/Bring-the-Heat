...
export const monsters = {
    ...
    normal: {
        fireBat: { name: "Fire Bat", hp: 40, attack: 8, hitChance: 0.35, goldDrop: [5, 12], asset: 'assets/enemies/Infernos_Gambit_-_Fire_Bat.png' },
        ...
        fireHound: { name: "Fire Hound", hp: 50, attack: 10, hitChance: 0.30, goldDrop: [8, 15], asset: 'assets/enemies/Infernos_Gambit_-_Fire_Hound.png' },
        fireSpirit: { name: "Fire Spirit", hp: 35, attack: 10, hitChance: 0.30, goldDrop: [12, 20], asset: 'assets/enemies/Infernos_Gambit_-_Fire_Spirit.png' },
        fireZombie: { name: "Fire Zombie", hp: 70, attack: 8, hitChance: 0.30, goldDrop: [10, 22], asset: 'assets/enemies/Infernos_Gambit_-_FIre_Zombie.png' },
        lavaGolem: { name: "Lava Golem", hp: 80, attack: 6, hitChance: 0.30, goldDrop: [15, 25], asset: 'assets/enemies/Infernos_Gambit_-_Lava_Golem.png' },
        fireArcher: { name: "Fire Archer", hp: 45, attack: 10, hitChance: 0.35, goldDrop: [14, 24], asset: 'assets/enemies/Infernos_Gambit_-_Fire_Archer.png'}
    },
    ...
    elite: {
        ...
        flyingKnight: { name: "Flying Fire Knight", hp: 120, attack: 20, hitChance: 0.15, goldDrop: [60, 90], asset: 'assets/enemies/Infernos_Gambit_-_Flying_Fire_Knight.png' },
        tallGolem: { name: "Tall Fire Golem", hp: 200, attack: 15, hitChance: 0.2, goldDrop: [70, 100], asset: 'assets/enemies/Infernos_Gambit_-_Tall_Fire_Golem.png' }
    },
